...
function updateWonderCost(){
    preciousGemCost = 10;
    preciousSilverCost = 10;
    preciousGoldCost = 10;
    preciousActivateGemCost = 10;
    preciousActivateSilverCost = 10;
    preciousActivateGoldCost = 10;
    energeticWoodCost = 10;
    energeticCharcoalCost = 0;
    energeticUraniumCost = 0;
    energeticActivateWoodCost = 10;
    energeticActivateCharcoalCost = 10;
    energeticActivateUraniumCost = 10;
    techSiliconCost = 10;
    techGoldCost = 10;
    techGemCost = 10;
    techActivateSiliconCost = 10;
    techActivateGoldCost = 10;
    techActivateGemCost = 10;
    ...
    commsWonderGoldCost = 10;
    commsWonderSiliconCost = 10;
    commsWonderIceCost = 10;
    rocketWonderLunariteCost = 1;
    rocketWonderTitaniumCost = 1;
    rocketWonderMetalCost = 1;
    antimatterWonderUraniumCost = 1;
    antimatterWonderLavaCost = 1;
    antimatterWonderOilCost = 1;
    antimatterWonderMethaneCost = 1;
    portalMeteoriteCost = 10;
    portalHeliumCost = 10;
    portalSiliconCost = 10;
    stargateWonderPlasmaCost = 10;
    stargateWonderSiliconCost = 10;
    stargateWonderMeteoriteCost = 10;
}
